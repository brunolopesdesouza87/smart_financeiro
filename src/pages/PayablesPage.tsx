  ...
  return (
    <div className="payables-page">
      ...
      <section className="summary-grid">
        ...
        <article className="summary-card received"><div className="summary-label"><CircleDollarSign size={16} /> Pago no M�s</div><strong>{money.format(summary.totalPaidInMonth)}</strong></article>
      ...
      <section className="page-card">
        <div className="page-header-row">
          <div>
            ...
            <p>Gest�o de despesas, vencimentos e pagamentos</p>
          </div>
